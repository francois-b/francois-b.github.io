...
const CVPage = () => {
  ...
  return (
    <div className="cv-container">
      {/* Print Button */}
      <button className="print-button" onClick={handlePrint} aria-label="Print CV" title="Print CV">
        <svg width="24" height="24" viewBox="0 0 32 32" fill="none">
          <rect x="8" y="4" width="16" height="6" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          <rect x="4" y="10" width="24" height="12" rx="2" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          <rect x="8" y="18" width="16" height="10" fill="currentColor" opacity="0.3" />
          <line x1="10" y1="21" x2="22" y2="21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      ...
      <main className="cv-main">
        ...
        <section className="cv-section summary-section">
          ...
          <p className="summary-text">
            Passionate developer with 5+ years of experience building scalable web applications and crafting
            delightful user experiences. Specializing in modern JavaScript frameworks, cloud architecture,
            and design systems.
          </p>
        </section>
        ...
        <section className="cv-section experience-section">
          <h2>
            <svg className="section-icon" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M8 7V5C8 4.46957 8.21071 3.96086 8.58579 3.58579C8.96086 3.21071 9.46957 3 10 3H14C14.5304 3 15.0391 3.21071 15.4142 3.58579C15.7893 3.96086 16 4.46957 16 5V7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <section className="cv-section education-section">
          <h2>
            <svg className="section-icon" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M12 14L21 9L12 4L3 9L12 14Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M12 14L12 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M6.5 11.5V16.5C6.5 17.163 7.76348 19 12 19C16.2365 19 17.5 17.163 17.5 16.5V11.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Education
          </h2>
        ...
        <section className="cv-section projects-section">
          ...
          <div className="projects-compact">
            <div className="project-item">
              ...
              <span className="project-tech">React • Node.js • Stripe • AWS</span>
            </div>
            <div className="project-item">
              <h3>Analytics Dashboard</h3>
              <p>Real-time data visualization dashboard processing millions of events</p>
              <span className="project-tech">Next.js • GraphQL • D3.js • PostgreSQL</span>
            </div>
            <div className="project-item">
              <h3>Design System</h3>
              <p>Component library and documentation site used across product teams</p>
              <span className="project-tech">React • Storybook • TypeScript</span>
            </div>
          </div>
        </section>
      </main>
